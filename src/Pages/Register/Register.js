...
<div className="flex flex-col mx-auto w-full max-w-md px-4 py-8 bg-white rounded-lg shadow dark:bg-gray-800 sm:px-6 md:px-8 lg:px-10">
    ...
    <div className="mt-8">
        <form action="#" autoComplete="off">
            ...
            Already have an account?
                <Link to="/login" target="_blank" className="inline-flex items-center text-sm font-bold text-center text-gray-500 hover:text-gray-700 dark:text-gray-100 dark:hover:text-white">
                    <span className="ml-2">
                    Login Here
                    </span>
                </Link>
