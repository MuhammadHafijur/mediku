...
<div className="p-8 bg-white dark:bg-gray-800 rounded-lg shadow mx-auto">
    <p className="text-center my-8 text-3xl font-bold text-gray-800 dark:text-white">
    ...
    <div className="flex items-center flex-col md:flex-row justify-center">
        <div className="p-4">
            <div className="text-center mb-4 opacity-90">
                <a href="#" className="block relative">
                    <img  alt="" src="https://i.ibb.co/R4Nnq1b/doc6.jpg" className="mx-auto object-cover h-88 w-64 "/>
                </a>
            </div>
        ...
        <div className="p-4">
            <div className="text-center mb-4 opacity-90">
                <a href="#" className="block relative">
                    <img alt="" src="https://i.ibb.co/Vt7k1ky/doctor2.jpg" className="mx-auto object-cover h-88 w-64 "/>
                </a>
            </div>
            <div className="text-center">
                <p className="text-2xl text-gray-800 dark:text-white">
        ...
        <div className="p-4">
            <div className="text-center mb-4 opacity-90">
                <a href="#" className="block relative">
                    <img alt="" src="https://i.ibb.co/XLr3qsW/doctor1.jpg" className="mx-auto object-cover h-88 w-64 "/>
                </a>
            </div>
            <div className="text-center">
                <p className="text-2xl text-gray-800 dark:text-white">
